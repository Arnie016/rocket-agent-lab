...
Interactive 3D rocket education prototype with multiple structured lessons, part picking, focused/all label modes, live challenge checklists, before/after slider impact readouts, physics equations, hardware/cost/failure breakdowns, WhatsApp sharing, and Astra, an OpenAI Realtime voice tutor with a prompt bar for scene-aware questions and replies.
