...
| --- | --- | --- |
| Build and run proof | Local proof present | `node server.mjs` serves the app at `http://127.0.0.1:5186`; latest local proof: `outputs/submission-proof-freshness-2026-07-21T2001Z.txt`. Re-run before handoff. |
